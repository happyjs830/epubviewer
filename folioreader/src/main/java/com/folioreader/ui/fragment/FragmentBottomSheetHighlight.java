...
public class FragmentBottomSheetHighlight extends BottomSheetDialogFragment {
    private ItemCallback mCallback;
    private int mPos;

    public FragmentBottomSheetHighlight(ItemCallback callback, int pos) {
        mCallback = callback;
        mPos = pos;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.layout_bottom_sheet_highlight, container, false);
    }
